...
const HomeContact = ({ darkMode }) => {
  ...
  return (
    <section
      id="contact"
      className={`w-full relative flex flex-col items-center py-24 overflow-hidden transition-colors duration-500
        ${
          darkMode
    ...
    >
      ...
      <h2 className="text-center font-bold  text-[clamp(1.6rem,3vw,2.5rem)]">
        Get in{" "}
      ...
      <div className="max-w-7xl mx-auto w-full px-6 md:px-16 py-16 sm:py-20 grid md:grid-cols-2 gap-10 md:gap-16 items-start relative z-10">

        <div
          className={`w-full h-[420px] rounded-3xl overflow-hidden shadow-2xl border
        ...
        <form
          ...
          className={`relative overflow-hidden rounded-3xl p-8 space-y-5 w-full shadow-2xl backdrop-blur-xl
            ${
              darkMode
        ...
        >
          ...
          <div className="relative z-10 space-y-4">
            ...
            <textarea
              ...
              className={`w-full p-3 h-28 rounded-xl resize-none border outline-none transition
                ${
                  darkMode
                    ? "bg-gray-800 text-gray-100 border-gray-700 focus:ring-indigo-400"
                    : "bg-white border-gray-300 focus:ring-blue-500"
              ...
              className={`w-full py-3 rounded-xl font-semibold text-white transition-all duration-300
                ${
                  darkMode
                    ...
                    : "bg-gradient-to-r from-blue-600 via-purple-500 to-pink-500 hover:opacity-90"
